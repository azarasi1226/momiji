...
dependencies {
    ...
    implementation("software.amazon.awssdk:cognitoidentityprovider:2.51.4") // Cognitoクライアント
    implementation("software.amazon.awssdk:s3:2.51.4") // S3 presigned URL 発行（画像アップロード）
    implementation("software.amazon.awssdk:sso:2.51.4") // AWS_PROFILE が SSO プロファイルの場合に credentials を解決するために必要
    implementation("software.amazon.awssdk:ssooidc:2.51.4") // 同上
