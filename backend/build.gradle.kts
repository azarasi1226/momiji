...
dependencies {
    ...
    // Axon
    implementation(platform("io.axoniq.framework:axoniq-framework-bom:5.3.1"))
    ...
    implementation("software.amazon.awssdk:cognitoidentityprovider:2.51.3") // Cognitoクライアント
    implementation("software.amazon.awssdk:s3:2.51.3") // S3 presigned URL 発行（画像アップロード）
    implementation("software.amazon.awssdk:sso:2.51.3") // AWS_PROFILE が SSO プロファイルの場合に credentials を解決するために必要
    implementation("software.amazon.awssdk:ssooidc:2.51.3") // 同上
